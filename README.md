...
```text
                                                                   user
insert 20000 facts                                             0.677313
export 20000 facts                                             0.024864
import 410626 bytes (20000 facts)                              0.039709
insert 10 facts                                                0.048823
query 10 times w/txn                                           2.543899
query 10 times w/o txn                                         0.049315
modify 10 attrs w/txn                                          2.030572
delete 10 facts w/txn                                          0.930672
(and (eq what 'issue-was-closed') (exists... -> 200            1.192246
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.293062
(and (eq what 'issue-was-closed') (exists... -> zero           1.234610
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.302075
(gt time '2024-03-23T03:21:43Z')                               0.418972
(gt cost 50)                                                   0.241591
(eq title 'Object Thinking 5000')                              0.039080
(and (eq foo 42.998) (or (gt bar 200) (absent z...             0.048728
(and (exists foo) (not (exists blue)))                         1.119002
(eq id (agg (always) (max id)))                                0.772235
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...             1.422887
(and (eq what "foo") (join "w<=what" (and (eq i...             7.515285
delete!                                                        0.287775
Taped.append() x50000                                          0.030458
Taped.each() x125                                              1.727668
Taped.delete_if() x375                                         0.846041
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-10-21 at 13:54,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/Yegorov/factbase/actions/runs/18686191223
